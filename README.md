...
- Nghiên cứu ứng dụng AI/LLM vào bài toán thực tế
- Triển khai mô hình AI cục bộ (Local LLM) với Ollama
- Thiết kế hệ thống điều khiển & robot tự động

</td>
<td width="50%" valign="top">

**🌐 Phát triển phần mềm**
- Xây dựng ứng dụng Full-Stack với Node.js & React
- Thiết kế API và hệ thống backend
- Phát triển công cụ tự động hóa quy trình
...
**Ngôn ngữ lập trình**
<br/>
<img src="https://skillicons.dev/icons?i=html,css,js,ts,python,nodejs"/>
...
<img height="165" src="https://github-readme-stats.vercel.app/api?username=Kzi207&show_icons=true&theme=tokyonight&hide_border=true&count_private=true"/>
<img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=Kzi207&layout=compact&theme=tokyonight&hide_border=true"/>
...
|:---|:---|:---|
| 🎓 **MyCTUTs** | Hệ thống quản lý sinh viên thông minh — điểm danh QR/GPS, quản lý điểm rèn luyện, học tập trực tuyến | React, TypeScript, Real-time Backend |
| 🤖 **AI ChatBot** | Chatbot tích hợp trí tuệ nhân tạo phục vụ hỗ trợ tự động | Node.js, AI API |
| 🎵 **Messenger Music Bot** | Bot phát nhạc tự động trên nền tảng Messenger | Node.js |
| 🧠 **Local AI System** | Triển khai mô hình ngôn ngữ lớn cục bộ | Ollama, LLM |
| ⚙️ **Automation Tools** | Bộ công cụ tự động hóa quy trình xử lý dữ liệu | Python, Node.js |
...
<img src="https://capsule-render.vercel.app/api?type=waving&section=footer&height=150&color=0:6A11CB,50:2575FC,100:00C9FF"/>
